...
public class InAppChannel extends InAppBase {
    ...
    public static final String ALIPAY_NOTIFY_URL = String.format("https://"+ip_address+":10013/%s/%s/client_success_callback",GameName,"alipay");
    public static final String WX_NOTIFY_URL = String.format("https://"+ip_address+":10013/%s/%s/client_success_callback",GameName,"wxpay");
    private static String RESTORE_URL = "https://"+ip_address+":10013/order/undelivered?user_id=%s";
    private static String UPDATE_ORDER_SUCCESS_URL = "https://"+ip_address+":10013/order/deliver";
    private static String GET_REFUNDED_ORDER_URL = "https://"+ip_address+":10013/order/refunded?user_id=%s";
...
//shrinkpartend
    ...
    private  String genProductArgs() {
        ...
        try {
            ...
            MercuryActivity.LogLocal("[InAppChannel][genProductArgs] rewritted order_id = " + order_id);
            packageParams.add(new BasicNameValuePair("attach",MercuryConst.Qindesc+","+DeviceId+","+channelname+","+order_id));
