		...
		AppsFlyerConversionListener conversionListener = new AppsFlyerConversionListener() {
			...
			public void onConversionDataSuccess(Map<String, Object> conversionData) {
				...
				for (String attrName : conversionData.keySet()) {
					LogLocal("attribute: " + attrName + " = " + conversionData.get(attrName));
				}
			}
			@Override
			public void onConversionDataFail(String errorMessage) {
				LogLocal("error getting conversion data: " + errorMessage);
			}
			@Override
...
//		Log.w("MercurySDK","key="+key);
		...
		{
			Log.w("MercurySDK","[MercuryApplication][SignatureVerify]Success");
		}
		else {
			Log.w("MercurySDK", "[MercuryApplication][SignatureVerify]Failed");
