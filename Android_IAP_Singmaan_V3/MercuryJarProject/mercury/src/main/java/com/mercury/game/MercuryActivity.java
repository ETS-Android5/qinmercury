...
//			LogLocal("[MercuryActivity][getDeviceId] Set imei as phone = ["+imei+"]");
	...
	public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)  {
		if(mInAppChannel != null) { LogLocal("[MercuryActivity]->onNewIntent:mInAppChannel="+mInAppChannel);mInAppChannel.onRequestPermissionsResult(mContext,requestCode,permissions); }
		if(mInAppAD != null) { LogLocal("[MercuryActivity]->onNewIntent:mInAppAD="+mInAppAD);mInAppAD.onRequestPermissionsResult(mContext,requestCode,permissions); }
